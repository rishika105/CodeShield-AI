            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              {
                token ?
                  (<Link
                    to="/security-scanner"
                    className="rounded-md bg-gradient-to-r from-neonPurple-500 to-neonBlue-500 px-6 py-3 text-lg font-semibold text-white hover:text-white shadow-lg "
                  >
                    Start Free Scan
                  </Link>) : (<Link
                    to="/auth"
              ...
              }
              {
                token ?
                  (<Link
                    to="/ai-playground"
                    className="rounded-md bg-indigoDark-700 px-6 py-3 text-lg font-semibold text-white hover:text-white shadow-lg  border border-indigoDark-600"
                  >
                    See How It Works
                  </Link>) : (<Link
                    to="/auth"
