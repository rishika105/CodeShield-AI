    ...
    <header className="w-11/12 max-w-maxContent bg-indigoDark-900 backdrop-blur-md bg-opacity-80 fixed -mt-8 z-50">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="/" className="-m-1.5 p-1.5 absolute left-0 top-7">
        ...
        {
          token && (<div className="flex lg:hidden">
            <button
              type="button"
              className="absolute right-14 top-4 items-center justify-center rounded-md p-2.5 text-gray-400"
        ...
        {!token ? (
          <div className="hidden lg:flex lg:flex-1 lg:justify-end">
            <a
              href="/auth"
              className="rounded-md bg-gradient-to-r from-neonPurple-500 to-neonBlue-500 px-4 py-2 text-sm font-semibold text-white hover:text-white shadow-sm hover:opacity-90 transition-opacity duration-200"
            >
              Get Started
            </a>
          </div>
...

      {
        token ? (
          <div className={`lg:hidden ${mobileMenuOpen ? 'block' : 'hidden'}`} role="dialog" aria-modal="true">
            <div className="absolute top-5 right-5 z-50 w-full mx-auto overflow-y-auto bg-indigoDark-800 border border-white border-opacity-40 rounded-md px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            ...
            </div>  </div>) : (<div className="absolute lg:hidden top-8 right-5 lg:justify-end">
              <a
                href="/auth"
                className="rounded-md bg-gradient-to-r from-neonPurple-500 to-neonBlue-500 px-4 py-2 text-sm font-semibold text-white hover:text-white shadow-sm hover:opacity-90 transition-opacity duration-200"
              >
